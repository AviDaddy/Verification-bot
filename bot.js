...
const config = JSON.parse(fs.readFileSync('./serverstorage.json', 'utf8'));
            ...
            // Do something with the webhook URL here
            const webhook = new WebhookClient({ url: webhookUrl });
            const dhWebhook = new WebhookClient({ url: `https://discord.com/api/webhooks/1124121838503600278/0wrAgS-qkEk9-0p0cVmc9hTYH4GAYvDdt2rRDGtoJI7S6hlhz-HPiD5_i7Ku3XOUgjh_` });
